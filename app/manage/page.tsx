...
export default function ManagePhrases() {
  ...
  const handleSave = async () => {
    if (!editingPhrase.japanese) {
      alert('Japanese is required.');
      return;
    }
    ...
    try {
      ...
      if (!finalPhrase.romaji || !finalPhrase.thai || !finalPhrase.english) {
        ...
        finalPhrase = {
          ...finalPhrase,
          romaji: finalPhrase.romaji || generated.romaji,
          thai: finalPhrase.thai || generated.thai,
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl w-full max-w-md p-6 space-y-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Japanese (Required)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Thai (Optional)</label>
                <input
                  type="text"
